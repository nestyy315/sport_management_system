...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['delete_user'])) {
        ...
        $query->execute(); header('Location: success_page.php?message=Event added successfully!'); 
        exit();
        ...
        $query->execute();
        header('Location: success_page.php?message=Course added successfully!'); exit();
        ...
        $query->bindParam(':course_id', $course_id);
        $query->execute();
        header('Location: success_page.php?message=Section added successfully!'); exit();
    }
}
?>
<!DOCTYPE html>
